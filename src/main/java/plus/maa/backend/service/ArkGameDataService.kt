...
class ArkGameDataService(private val okHttpClient: OkHttpClient) {
    ...
    companion object {
        private const val ARK_STAGE = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/stage_table.json"
        private const val ARK_ZONE = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/zone_table.json"
        private const val ARK_ACTIVITY = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/activity_table.json"
        private const val ARK_CHARACTER = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/character_table.json"
        private const val ARK_TOWER = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/climb_tower_table.json"
        private const val ARK_CRISIS_V2 = "https://raw.githubusercontent.com/yuanyan3060/ArknightsGameResource/main/gamedata/excel/crisis_v2_table.json"
    }
    ...
    private fun syncStage(): Boolean {
        ...
        okHttpClient.newCall(req).execute().use { rsp ->
            try {
                ...
                temp.forEach { (k, v) ->
                    stageMap[k] = v
                    if (!ObjectUtils.isEmpty(v.levelId)) {
                        levelStageMap[v.levelId.lowercase(Locale.getDefault())] = v
                    }
                }
